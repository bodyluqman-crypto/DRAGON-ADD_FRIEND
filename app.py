    ...
    while True:
        with storage_lock:
            ...
            for uid in expired_uids:
                requests.get(f"https://zix-official-bot.vercel.app/remove/3947598839/E20FF9393930AC0A06A649DD8567821624FAE79250B4520F04E917745FD96893/{uid}")
                del uids[uid]
...
def add_uid():
    ...
    if permanent:
        ...
        requests.get(f"https://zix-official-bot.vercel.app/add/3947598839/E20FF9393930AC0A06A649DD8567821624FAE79250B4520F04E917745FD96893/{uid}")
    else:
